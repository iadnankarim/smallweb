/**
 * The seed web. Same content the backend seed inserts, so the mock and the real
 * API behave the same. Links to harbourmap.zz, moonbakery.zz and oldferry.zz
 * are deliberate: nobody ever published those addresses.
 */
